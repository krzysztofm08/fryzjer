...
<html lang="pl-PL">
	...
	<title>Zaloguj się &lsaquo; Beauty Life &#8212; WordPress</title>
	<link rel="dns-prefetch" href="//s.w.org">
<link rel="stylesheet" id="dashicons-css" href="/fryzjer/wp-includes/css/dashicons.min.css?ver=5.6.1" media="all">
<link rel="stylesheet" id="buttons-css" href="/fryzjer/wp-includes/css/buttons.min.css?ver=5.6.1" media="all">
<link rel="stylesheet" id="forms-css" href="/fryzjer/wp-admin/css/forms.min.css?ver=5.6.1" media="all">
<link rel="stylesheet" id="l10n-css" href="/fryzjer/wp-admin/css/l10n.min.css?ver=5.6.1" media="all">
<link rel="stylesheet" id="login-css" href="/fryzjer/wp-admin/css/login.min.css?ver=5.6.1" media="all">
	<meta name="robots" content="noindex,noarchive">
	<meta name="referrer" content="strict-origin-when-cross-origin">
		<meta name="viewport" content="width=device-width">
	<link rel="icon" href="/fryzjer/wp-content/uploads/2021/01/scissors-24188_1280-150x150.png" sizes="32x32">
<link rel="icon" href="/fryzjer/wp-content/uploads/2021/01/scissors-24188_1280.png" sizes="192x192">
<link rel="apple-touch-icon" href="/fryzjer/wp-content/uploads/2021/01/scissors-24188_1280.png">
<meta name="msapplication-TileImage" content="/wp-content/uploads/2021/01/scissors-24188_1280.png">
	</head>
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="/fryzjer/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Zaloguj się">
					...
					<p id="nav">
								<a href="/fryzjer/wp-login.php?action=lostpassword">Nie pamiętasz hasła?</a>
			</p>
					<script type="text/javascript">
			function wp_attempt_focus() {setTimeout( function() {try {d = document.getElementById( "user_login" );d.focus(); d.select();} catch( er ) {}}, 200);}
wp_attempt_focus();
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog"><a href="/fryzjer/">
		&larr; Przejdź do Beauty Life		</a></p>
			</div>
	<script src="/fryzjer/wp-includes/js/jquery/jquery.min.js?ver=3.5.1" id="jquery-core-js"></script>
<script src="/fryzjer/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script id="zxcvbn-async-js-extra">
var _zxcvbnSettings = {"src":"\/wp-includes\/js\/zxcvbn.min.js"};
</script>
<script src="/fryzjer/wp-includes/js/zxcvbn-async.min.js?ver=1.0" id="zxcvbn-async-js"></script>
<script src="/fryzjer/wp-includes/js/dist/vendor/wp-polyfill.min.js?ver=7.4.4" id="wp-polyfill-js"></script>
...
<script src="/fryzjer/wp-includes/js/dist/i18n.min.js?ver=ac389435e7fd4ded01cf603f3aaba6a6" id="wp-i18n-js"></script>
...
<script src="/fryzjer/wp-admin/js/password-strength-meter.min.js?ver=5.6.1" id="password-strength-meter-js"></script>
<script src="/fryzjer/wp-includes/js/underscore.min.js?ver=1.8.3" id="underscore-js"></script>
<script id="wp-util-js-extra">
var _wpUtilSettings = {"ajax":{"url":"\/fryzjer\/wp-admin\/admin-ajax.php"}};
</script>
<script src="/fryzjer/wp-includes/js/wp-util.min.js?ver=5.6.1" id="wp-util-js"></script>
...
<script src="/fryzjer/wp-admin/js/user-profile.min.js?ver=5.6.1" id="user-profile-js"></script>
			<script>
